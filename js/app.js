                    ...
                    try {
                        ...
                        if (doc.exists) {
                            ...
                            if (data.lessonProgress) {
                                lessonProgress = { ...lessonProgress, ...data.lessonProgress };
...
async function syncProgressUp() {
    ...
    if (user && typeof db !== 'undefined' && db) {
        ...
        } catch (e) { console.error("Error syncing progress up:", e); }
    }
}
...
function openModule(id) {
    ...
    const marquee = document.getElementById('hero-marquee-band');
...
async function exportProgress() {
    ...
    a.href = url;
    a.download = `pyneo_progreso_${new Date().toLocaleDateString().replace(/\//g, '-')}.txt`;
