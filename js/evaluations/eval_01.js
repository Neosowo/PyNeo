    ...
    questions: [
        ...
        },
        {
            ...
            question: `
                ...
                <p class="text-gray-300 mb-2">Usa <strong>división entera</strong> <code class="text-neon-green">//</code>:</p>
            ...
            help: {
                ...
                concept: "Este ejercicio usa operadores de división especial: // (entero) y % (módulo).",
                steps: [
