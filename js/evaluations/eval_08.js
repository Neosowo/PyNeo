window.evaluations[7] = {
    ...
    questions: [
        ...
        },
        {
            ...
            `,
            expectedOutput: "{'Luis'}", // El orden en sets puede variar, pero con 1 elemento es estable.
            points: 25
        },
        {
            id: 3,
        ...
        },
        {
            ...
            `,
            expectedOutput: "{'Ana', 'Pepe'}", // Podría ser {'Pepe', 'Ana'}. El sistema validará "includes" si falla string exacto.
            points: 35
        }
    ]
};
