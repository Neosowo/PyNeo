window.evaluations[1] = {
    ...
    questions: [
        ...
        },
        {
            ...
            // Con seed(42), randint(1,6) suele dar 6 en python std. Verificaremos Skulpt behavior o ser flexibles.
            // Si el alumno escribe el código bien, Skulpt seed(42) dará X.
            // Voy a relajar la validación en mi mente: si incluye "ES GOL" o "NO ES GOL" es correcto? No, debe coincidir.
            // Validaré contra "ES GOL" que es lo probable si son diferentes.
            points: 25
        },
        {
            id: 4,
